 ...
 * The template for displaying house page.
 *
 * @package understrap
 */
...
<div class="<?php echo esc_attr($container); ?> pt-5">
    ...
    <div class="col-md-6 offset-md-6 pr-0 pt-3">
        <?php get_search_form(); ?>
    </div>
...
<div class="form-wrapper mt-5 pt-5 pb-5 mb-5 block-shadow" id="steps-section">
  <?php if ( get_field( 'form_name' ) ) { ?>
  <h2 class="text-center section-title">
    <?= get_field( 'form_name' ) ?>
</h2>
<?php } ?>
<form method="post" enctype="multipart/form-data" id="add_landscape" class="mt-5 text-center">
    ...
    <div class="form-row justify-content-center">
        ...
        <div class="form-group col-md-5">
            <input class="input-border w-100 p-3" type="text" name="dameged" class="ref-point-input" placeholder="Що саме пошкоджено:" required/>
        </div>
    </div>
