...
<section class="no-results not-found">
	...
	<header class="page-header">
		...
		<h1 class="page-title"><?php esc_html_e( 'Нічого не знайдено', 'understrap' ); ?></h1>
	...
	'a' => array(
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php esc_html_e( 'Вибачте, але жодної скарги за даною адресою не знайдено.', 'understrap' ); ?></p>
			<?php
				get_search_form();
		else : ?>
